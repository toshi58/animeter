...
ActiveRecord::Schema.define(version: 2020_11_24_021440) do
  ...
  create_table "wants", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["anime_id"], name: "index_wants_on_anime_id"
  ...
  add_foreign_key "wants", "animes"
  add_foreign_key "wants", "users"
  add_foreign_key "watches", "animes"
